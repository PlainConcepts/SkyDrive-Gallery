$(function () {    
    "use strict";
    var CLIENTID = "YOURCLIENTID", // client_id needed for the SkyDrive API
        REDIRECT_URL = "http://redirect.url.com/", // redirect_url for the SkyDrive API 
        directoryName = "galleryFolder", //directory in which we are going to search for photos
